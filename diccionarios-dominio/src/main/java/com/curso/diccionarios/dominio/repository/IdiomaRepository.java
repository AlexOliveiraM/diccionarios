...
public interface IdiomaRepository {
    ...
    void newIdioma(@NonNull Idioma idioma) throws InvalidArgumentException, NonExistentEntityException;

    void updateIdioma(@NonNull Idioma idioma) throws InvalidArgumentException, AlreadyExistsEntityException;
